...
///////////////////////////////////////////////////////////////////////////////
  ...
  enum locateresult preciselocate(point searchpt, triface* searchtet, size_t);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  size_t lawson3d(queue* flipqueue);
  size_t lawson(queue* flipqueue);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  bool incrflipdelaunay(triface*, point*, size_t, bool, bool, REAL, queue*);
  size_t delaunizevertices();
...
///////////////////////////////////////////////////////////////////////////////
  ...
  enum finddirectionresult finddirection(triface* searchtet, point, size_t);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  void transfernodes();
  size_t reconstructmesh();
  void insertconstrainedpoints(tetgenio *addio);
  bool p1interpolatebgm(point pt, triface* bgmtet, size_t *scount);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  size_t hullsize;                           // Number of faces of convex hull.
  size_t insegments;                               // Number of input segments.
  size_t meshedges;                             // Number of output mesh edges.
  ...
  size_t samples;               // Number of random samples for point location.
  ...
  size_t ptloc_count, ptloc_max_count;
  size_t orient3dcount;
  size_t inspherecount, insphere_sos_count;
  size_t flip14count, flip26count, flipn2ncount;
  size_t flip22count;
  size_t inserthullcount;
  size_t maxbowatcavsize, totalbowatcavsize, totaldeadtets;
  size_t across_face_count, across_edge_count, across_max_count;
  size_t maxcavsize, maxregionsize;
  size_t ndelaunayedgecount, cavityexpcount;
  size_t opt_tet_peels, opt_face_flips, opt_edge_flips;

  size_t abovecount;                     // Number of abovepoints calculation.
  size_t bowatvolcount, bowatsubcount, bowatsegcount;       // Bowyer-Watsons.
  size_t updvolcount, updsubcount, updsegcount;   // Bow-Wat cavities updates.
  size_t failvolcount, failsubcount, failsegcount;           // Bow-Wat fails.
  size_t outbowatcircumcount;    // Number of circumcenters outside Bowat-cav.
  size_t r1count, r2count, r3count;        // Numbers of edge splitting rules.
  size_t cdtenforcesegpts;                // Number of CDT enforcement points.
  size_t rejsegpts, rejsubpts, rejtetpts;        // Number of rejected points.
  size_t optcount[10];            // Numbers of various optimizing operations.
  size_t flip23s, flip32s, flip22s, flip44s;     // Number of flips performed.
...
inline void tetgenmesh::sinfect(face& s) {
  ...
  // s.sh[6] = (shellface) ((size_t) s.sh[6] | (size_t) 4l);
}
