...
CFLAGS = $(INCDIR) -std=gnu++11 -m64 -O2 -static -static-libgcc -static-libstdc++ -fopenmp -DNDEBUG -D_FILE_OFFSET_BITS=64 -DWX_PRECOMP -fno-common -fpermissive -Wall -Wundef -Wunused-parameter -Wno-ctor-dtor-privacy -Woverloaded-virtual -Wno-deprecated-declarations
LFLAGS = $(LIBDIR) -std=gnu++11 -m64 -fopenmp -static -static-libgcc -static-libstdc++ -s $(LIBALG) $(LIBWX) $(LIBVTK) $(LIBWIN)
