...
LIBWX = -lwxmsw31u -liconv -lwxjpeg -lwxpng -lwxexpat -lwxregexu -lwxscintilla -lwxzlib -lwxtiff
...
CFLAGS = $(INCDIR) -std=gnu++17 -m64 -O2 -static -fopenmp -DNDEBUG -D_FILE_OFFSET_BITS=64 -DWX_PRECOMP -fno-common -fpermissive -Wall -Wundef -Wunused-parameter -Wno-ctor-dtor-privacy -Woverloaded-virtual -Wno-deprecated-declarations
LFLAGS = $(LIBDIR) -std=gnu++17 -m64 -fopenmp -static -s $(LIBALG) $(LIBWX) $(LIBVTK) $(LIBWIN)
