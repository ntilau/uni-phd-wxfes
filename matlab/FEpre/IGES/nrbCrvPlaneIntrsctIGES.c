...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    umax = (double)mxGetPr(mxGetField(nurbsstructure, 0, "knots"))[mxGetN(mxGetField(nurbsstructure, 0, "coefs"))];
    
    paramspacing=(umax-umin)/50.0;
    paramtmp[0]=umin;
    minParam[0]=umin;
    
    NURBScurveEval(degU, mxGetPr(mxGetField(nurbsstructure, 0, "coefs")), (int)mxGetN(mxGetField(nurbsstructure, 0, "coefs")), mxGetPr(mxGetField(nurbsstructure, 0, "knots")), &paramtmp[0], 1, &pnttmp[0], left, right, N);
    ...
    if (minFuncVal<1e-12){
        ...
        for (i = 0; i < MAXITER; i++){
            ...
            nrbD1D2eval(nurbsstructure, dnrbsstructure, d2nrbsstructure, &minParam[0], &pnttmp[0], &pderu[0], &pderuu[0], &bspPnts[0], left, right, N);
