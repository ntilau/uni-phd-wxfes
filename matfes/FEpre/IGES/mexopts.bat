...
set INCLUDE=%INCLUDE%;c:\MinGW64\include;%MATLAB%\extern\include;
set LIB=%LIB%;c:\MinGW64\lib;%MATLAB%\extern\lib\win64\microsoft;
...
set LIBLOC=-L"%MATLAB%\bin\win64" -L"%MATLAB%\extern\lib\win64\microsoft" 
set LINKER=gcc
set LINKFLAGS= -static-libgcc -shared mex.def %LIBLOC%
