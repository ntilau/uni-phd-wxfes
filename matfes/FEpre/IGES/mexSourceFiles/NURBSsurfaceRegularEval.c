...
static void NURBSsurfaceRegularEval(int orderU, int orderV, double *cp, int ncp, int kcp, double *knotU, double *knotV, double u0, double deltau, int numu, double v0, double deltav, int numv, double *ep){
    ...
    int i, j, ii, jj, indi, indj, epind, indi2, indj2, ind, myint, myint2;
    int numuMinusOne, numvMinusOne, ncpMinusOne, kcpMinusOne, fourncp, fourncpMinusFour;
    int degU, degV, *spanArray, sdU, spanScalar, sdV;
    ...
    if ((numu*orderU*sizeof(double)+numu*sizeof(int)+orderV*sizeof(double))<(numv*orderV*sizeof(double)+numv*sizeof(int)+orderU*sizeof(double))){
        ...
        spanArray  = (int*) malloc(numu*sizeof(int)+1);
        ...
        spanArray  = (int*) malloc(numv*sizeof(int)+1);
