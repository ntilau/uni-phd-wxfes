...
#include "vtktheora_export.h"
#include "vtk_theora_mangle.h"
 ...
 */
VTKTHEORA_EXPORT const char *theora_version_string(void);
...
*/
VTKTHEORA_EXPORT ogg_uint32_t theora_version_number(void);
 ...
 * \retval 0 Success
 */
VTKTHEORA_EXPORT int theora_encode_init(theora_state *th, theora_info *ti);
 ...
 * \retval 0 Success
 */
VTKTHEORA_EXPORT int theora_encode_YUVin(theora_state *t, yuv_buffer *yuv);
 ...
 * \retval 1 Success
 */
VTKTHEORA_EXPORT int theora_encode_packetout( theora_state *t, int last_p,
                                    ogg_packet *op);
 ...
 * \retval 0 Success
 */
VTKTHEORA_EXPORT int theora_encode_header(theora_state *t, ogg_packet *op);
 ...
 * \retval 0 Success
 */
VTKTHEORA_EXPORT int theora_encode_comment(theora_comment *tc, ogg_packet *op);
 ...
 * \retval 0 Success
 */
VTKTHEORA_EXPORT int theora_encode_tables(theora_state *t, ogg_packet *op);
 ...
 */
VTKTHEORA_EXPORT int theora_decode_header(theora_info *ci, theora_comment *cc,
                                ogg_packet *op);
 ...
 * \retval 0 Success
 */
VTKTHEORA_EXPORT int theora_decode_init(theora_state *th, theora_info *c);
 ...
 */
VTKTHEORA_EXPORT int theora_decode_packetin(theora_state *th,ogg_packet *op);
 ...
 * \retval 0 Success
 */
VTKTHEORA_EXPORT int theora_decode_YUVout(theora_state *th,yuv_buffer *yuv);
 ...
 */
VTKTHEORA_EXPORT int theora_packet_isheader(ogg_packet *op);
 ...
 * Thus function was added in the 1.0alpha4 release.
 */
VTKTHEORA_EXPORT int theora_packet_iskeyframe(ogg_packet *op);
 ...
 * Thus function was added in the 1.0alpha4 release.
 */
VTKTHEORA_EXPORT ogg_int64_t theora_granule_frame(theora_state *th,ogg_int64_t granulepos);
 ...
 */
VTKTHEORA_EXPORT double theora_granule_time(theora_state *th,ogg_int64_t granulepos);
 ...
 */
VTKTHEORA_EXPORT void theora_info_init(theora_info *c);
 ...
 * \param c A theora_info struct to initialize.
 */
VTKTHEORA_EXPORT void theora_info_clear(theora_info *c);

/**
 * Free all internal data associated with a theora_state handle.
 * \param t A theora_state handle.
 */
VTKTHEORA_EXPORT void theora_clear(theora_state *t);

/**
 * Initialize an allocated theora_comment structure
 * \param tc An allocated theora_comment structure 
 **/
VTKTHEORA_EXPORT void theora_comment_init(theora_comment *tc);
...
VTKTHEORA_EXPORT void theora_comment_add(theora_comment *tc, char *comment);
 ...
 * the theora_comment structure directly.
 **/
VTKTHEORA_EXPORT void theora_comment_add_tag(theora_comment *tc,
                                       char *tag, char *value);
...
VTKTHEORA_EXPORT char *theora_comment_query(theora_comment *tc, char *tag, int count);
 ...
 **/
VTKTHEORA_EXPORT int   theora_comment_query_count(theora_comment *tc, char *tag);

/**
 * Clear an allocated theora_comment struct so that it can be freed.
 * \param tc An allocated theora_comment structure.
 **/
VTKTHEORA_EXPORT void  theora_comment_clear(theora_comment *tc);
...
VTKTHEORA_EXPORT int theora_control(theora_state *th,int req,void *buf,size_t buf_sz);
