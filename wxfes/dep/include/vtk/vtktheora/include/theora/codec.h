...
VTKTHEORA_EXPORT const char *th_version_string(void);
...
VTKTHEORA_EXPORT ogg_uint32_t th_version_number(void);
...
VTKTHEORA_EXPORT ogg_int64_t th_granule_frame(void *_encdec,ogg_int64_t _granpos);
 ...
 * \retval -1 The given granule position was invalid (i.e. negative).*/
VTKTHEORA_EXPORT double th_granule_time(void *_encdec,ogg_int64_t _granpos);
...
VTKTHEORA_EXPORT int th_packet_isheader(ogg_packet *_op);
...
VTKTHEORA_EXPORT int th_packet_iskeyframe(ogg_packet *_op);
/*@}*/
...
VTKTHEORA_EXPORT void th_comment_init(th_comment *_tc);
...
VTKTHEORA_EXPORT void th_comment_add(th_comment *_tc, char *_comment);
/**Add a comment to an initialized #th_comment structure.
 * \note Neither th_comment_add() nor th_comment_add_tag() support
 *  comments containing null values, although the bitstream format does
 *  support them.
...
VTKTHEORA_EXPORT void th_comment_add_tag(th_comment *_tc,char *_tag,char *_val);
...
VTKTHEORA_EXPORT char *th_comment_query(th_comment *_tc,char *_tag,int _count);
...
VTKTHEORA_EXPORT int th_comment_query_count(th_comment *_tc,char *_tag);
...
VTKTHEORA_EXPORT void th_comment_clear(th_comment *_tc);
/*@}*/
/*@}*/
