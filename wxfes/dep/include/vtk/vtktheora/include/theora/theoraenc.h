...
VTKTHEORA_EXPORT th_enc_ctx *th_encode_alloc(const th_info *_info);
...
VTKTHEORA_EXPORT int th_encode_ctl(th_enc_ctx *_enc,int _req,void *_buf,size_t _buf_sz);
...
VTKTHEORA_EXPORT int th_encode_flushheader(th_enc_ctx *_enc,
 ...
 *                    completed.*/
VTKTHEORA_EXPORT int th_encode_ycbcr_in(th_enc_ctx *_enc,th_ycbcr_buffer _ycbcr);
...
VTKTHEORA_EXPORT int th_encode_packetout(th_enc_ctx *_enc,int _last,ogg_packet *_op);
/**Frees an allocated encoder instance.
 * \param _enc A #th_enc_ctx handle.*/
VTKTHEORA_EXPORT void th_encode_free(th_enc_ctx *_enc);
/*@}*/
/*@}*/
