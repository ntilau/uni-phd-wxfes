...
private:
  vtkCPExodusIINodalCoordinatesTemplate(const vtkCPExodusIINodalCoordinatesTemplate&) = delete;
  void operator=(const vtkCPExodusIINodalCoordinatesTemplate&) = delete;
